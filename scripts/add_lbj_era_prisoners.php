...
function addP(array $p): array {
    ...
    $prisoner = Prisoner::create(array_filter([
        ...
        'description' => $p['description'] ?? null, 'era' => $p['era'] ?? '1960s',
...
foreach ([
    [
        'p' => ['name' => 'Lolita Lebrón', 'first_name' => 'Lolita', 'last_name' => 'Lebrón', 'aka' => 'Dolores Lebrón Sotomayor',
            ...
            'ideologies' => ['Puerto Rican independence', 'Anti-colonialism'], 'era' => '1960s',
...
[$davidMiller, $created] = addP([
    ...
    'ideologies' => ['Catholic pacifism', 'Anti-war'], 'era' => '1960s',
...
[$cornell, $created] = addP([
    ...
    'ideologies' => ['Catholic pacifism', 'Anti-war', 'Christian nonviolence'], 'era' => '1960s',
...
[$mitchell, $created] = addP([
    ...
    'ideologies' => ['Anti-war (selective conscientious objection)', 'Pacifism', 'Anti-imperialism'], 'era' => '1960s',
...
[$obrien, $created] = addP([
    ...
    'ideologies' => ['Anti-war', 'Free speech'], 'era' => '1960s',
...
[$levy, $created] = addP([
    ...
    'ideologies' => ['Anti-war', 'Medical ethics'], 'era' => '1960s',
...
[$noyd, $created] = addP([
    ...
    'ideologies' => ['Selective conscientious objection', 'Anti-war'], 'era' => '1960s',
...
[$sellers, $created] = addP([
    ...
    'ideologies' => ['Civil rights', 'Black Power', 'Anti-war'], 'era' => '1960s',
...
[$rfw, $created] = addP([
    ...
    'ideologies' => ['Black self-defense', 'Black nationalism', 'Anti-imperialism'], 'era' => '1960s',
...
[$mallory, $created] = addP([
    ...
    'ideologies' => ['Civil rights', 'Black self-defense', 'School desegregation'], 'era' => '1960s',
...
foreach ([
    ...
    [
        'p' => ['name' => 'Annell Ponder', 'first_name' => 'Annell', 'last_name' => 'Ponder',
            ...
            'ideologies' => ['Civil rights', 'Voter education'], 'era' => '1960s',
    ...
    [
        'p' => ['name' => 'June Johnson', 'first_name' => 'June', 'last_name' => 'Johnson',
            ...
            'state' => 'Mississippi', 'affiliation' => ['SNCC', 'Mississippi Freedom Democratic Party'],
            'ideologies' => ['Civil rights', 'Voting rights'], 'era' => '1960s',
    ...
    [
        'p' => ['name' => 'Bob Moses', 'first_name' => 'Robert', 'middle_name' => 'Parris', 'last_name' => 'Moses',
            ...
            'ideologies' => ['Civil rights', 'Voting rights', 'Anti-war'], 'era' => '1960s',
    ...
    [
        'p' => ['name' => 'James Bevel', 'first_name' => 'James', 'middle_name' => 'Luther', 'last_name' => 'Bevel',
            ...
            'ideologies' => ['Civil rights', 'Nonviolence', 'Anti-war'], 'era' => '1960s',
    ...
    [
        'p' => ['name' => 'James Lawson', 'first_name' => 'James', 'middle_name' => 'Morris', 'last_name' => 'Lawson',
            ...
            'ideologies' => ['Christian nonviolence', 'Civil rights', 'Anti-war'], 'era' => '1960s',
    ...
    [
        'p' => ['name' => 'Bernard Lafayette', 'first_name' => 'Bernard', 'last_name' => 'Lafayette',
            ...
            'ideologies' => ['Civil rights', 'Nonviolence'], 'era' => '1960s',
...
[$adams, $created] = addP([
    ...
    'ideologies' => ['Indigenous sovereignty', 'Treaty rights', 'Native self-determination'], 'era' => '1960s',
...
[$bfj, $created] = addP([
    ...
    'ideologies' => ['Indigenous sovereignty', 'Treaty rights', 'Environmental stewardship'], 'era' => '1960s',
...
[$mccloud, $created] = addP([
    ...
    'ideologies' => ['Indigenous sovereignty', 'Treaty rights', 'Indigenous feminism'], 'era' => '1960s',
