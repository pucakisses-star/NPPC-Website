#!/usr/bin/env bash
# Batch 339: Seven verified Balayan military detainees; accumulate toward 100-person PR.
# After merging, pull main and apply earlier pending batches in order.
# sudo -u www-data bash database/data/run-batch-339.sh --dry-run
# sudo -u www-data bash database/data/run-batch-339.sh
...
if [[ $# -eq 1 && "$1" == "--dry-run" ]]; then
    ...
    echo "Usage: bash database/data/run-batch-339.sh [--dry-run]" >&2
    exit 2
fi
...
$payload = json_decode(File::get(base_path("database/data/fixes/batch339.json")), true, 512, JSON_THROW_ON_ERROR);
if (($payload["batch"] ?? null) !== 339 || ($payload["expected_count"] ?? null) !== 7 || count($payload["entries"] ?? []) !== 7) {
...
if ($precisionProbe->computeImprisonedForDays() !== null) { throw new \RuntimeException("Pull the accompanying partial-date counter fix before applying batch 339."); }
...
foreach ($payload["entries"] as $entry) {
    ...
    $expected = ["prudencia-masancay" => ["name" => "Prudencia Masancay", "first_name" => "Prudencia", "middle_name" => null, "last_name" => "Masancay", "aka" => null, "description" => "Prudencia Masancay was held by US military authorities at Balayan, Batangas, during the Philippine-American War. The Army register classified this detainee as a suspected insurgent. The record documents several weeks of confinement followed by release.", "affiliation" => ["Philippine-American War"], "state" => "Philippines", "era" => "1900s", "lat" => null, "lng" => null, "in_custody" => false, "released" => true, "website" => null, "gender" => null, "race" => null, "inmate_number" => null], "apolonio-aranis" => ["name" => "Apolonio Aranis", "first_name" => "Apolonio", "middle_name" => null, "last_name" => "Aranis", "aka" => null, "description" => "Apolonio Aranis was held by US military authorities at Balayan, Batangas, during the Philippine-American War. The Army register classified this detainee as a suspected insurgent. The record documents several weeks of confinement followed by release.", "affiliation" => ["Philippine-American War"], "state" => "Philippines", "era" => "1900s", "lat" => null, "lng" => null, "in_custody" => false, "released" => true, "website" => null, "gender" => null, "race" => null, "inmate_number" => null], "catalino-cabrera" => ["name" => "Catalino Cabrera", "first_name" => "Catalino", "middle_name" => null, "last_name" => "Cabrera", "aka" => null, "description" => "Catalino Cabrera was held by US military authorities at Balayan, Batangas, during the Philippine-American War. The Army register classified this detainee as a suspected insurgent. The record documents several weeks of confinement followed by release.", "affiliation" => ["Philippine-American War"], "state" => "Philippines", "era" => "1900s", "lat" => null, "lng" => null, "in_custody" => false, "released" => true, "website" => null, "gender" => null, "race" => null, "inmate_number" => null], "ramon-hernandez" => ["name" => "Ramon Hernandez", "first_name" => "Ramon", "middle_name" => null, "last_name" => "Hernandez", "aka" => null, "description" => "Ramon Hernandez was held by US military authorities at Balayan, Batangas, during the Philippine-American War. The Army register classified this detainee as a suspected insurgent. The record documents several weeks of confinement followed by release.", "affiliation" => ["Philippine-American War"], "state" => "Philippines", "era" => "1900s", "lat" => null, "lng" => null, "in_custody" => false, "released" => true, "website" => null, "gender" => null, "race" => null, "inmate_number" => null], "felix-paderona" => ["name" => "Felix Paderona", "first_name" => "Felix", "middle_name" => null, "last_name" => "Paderona", "aka" => null, "description" => "Felix Paderona was held by US military authorities at Balayan, Batangas, during the Philippine-American War. The Army register classified this detainee as a suspected insurgent. The record documents several weeks of confinement followed by release.", "affiliation" => ["Philippine-American War"], "state" => "Philippines", "era" => "1900s", "lat" => null, "lng" => null, "in_custody" => false, "released" => true, "website" => null, "gender" => null, "race" => null, "inmate_number" => null], "leon-badillon" => ["name" => "Leon Badillon", "first_name" => "Leon", "middle_name" => null, "last_name" => "Badillon", "aka" => null, "description" => "Leon Badillon was held by US military authorities at Balayan, Batangas, during the Philippine-American War. The Army register classified this detainee as an insurgent. The record documents several days of confinement followed by release.", "affiliation" => ["Philippine-American War"], "state" => "Philippines", "era" => "1900s", "lat" => null, "lng" => null, "in_custody" => false, "released" => true, "website" => null, "gender" => null, "race" => null, "inmate_number" => null], "patricio-alino" => ["name" => "Patricio Alino", "first_name" => "Patricio", "middle_name" => null, "last_name" => "Alino", "aka" => null, "description" => "Patricio Alino was held by US military authorities at Balayan, Batangas, during the Philippine-American War. The Army register classified this detainee as an insurgent. The record documents several days of confinement followed by release.", "affiliation" => ["Philippine-American War"], "state" => "Philippines", "era" => "1900s", "lat" => null, "lng" => null, "in_custody" => false, "released" => true, "website" => null, "gender" => null, "race" => null, "inmate_number" => null]];
    ...
    $reviewed = ["prudencia-masancay" => [], "apolonio-aranis" => [], "catalino-cabrera" => [], "ramon-hernandez" => [], "felix-paderona" => [], "leon-badillon" => [], "patricio-alino" => []];
    if ($entry["dates"] !== $reviewed[$entry["key"]]) { throw new \RuntimeException("Unexpected reviewed dates."); }
    $reviewed = ["prudencia-masancay" => [["arrest_date" => ["year" => 1900, "month" => 11, "day" => 27], "incarceration_date" => ["year" => 1900, "month" => 11, "day" => 27], "release_date" => ["year" => 1900, "month" => 12, "day" => 26]]], "apolonio-aranis" => [["arrest_date" => ["year" => 1900, "month" => 11, "day" => 27], "incarceration_date" => ["year" => 1900, "month" => 11, "day" => 27], "release_date" => ["year" => 1900, "month" => 12, "day" => 26]]], "catalino-cabrera" => [["arrest_date" => ["year" => 1900, "month" => 11, "day" => 27], "incarceration_date" => ["year" => 1900, "month" => 11, "day" => 27], "release_date" => ["year" => 1900, "month" => 12, "day" => 27]]], "ramon-hernandez" => [["arrest_date" => ["year" => 1900, "month" => 11, "day" => 27], "incarceration_date" => ["year" => 1900, "month" => 11, "day" => 27], "release_date" => ["year" => 1900, "month" => 12, "day" => 20]]], "felix-paderona" => [["arrest_date" => ["year" => 1900, "month" => 11, "day" => 27], "incarceration_date" => ["year" => 1900, "month" => 11, "day" => 27], "release_date" => ["year" => 1900, "month" => 12, "day" => 18]]], "leon-badillon" => [["arrest_date" => ["year" => 1901, "month" => 3, "day" => 1], "incarceration_date" => ["year" => 1901, "month" => 3, "day" => 1], "release_date" => ["year" => 1901, "month" => 3, "day" => 8]]], "patricio-alino" => [["arrest_date" => ["year" => 1901, "month" => 3, "day" => 4], "incarceration_date" => ["year" => 1901, "month" => 3, "day" => 4], "release_date" => ["year" => 1901, "month" => 3, "day" => 10]]]];
    if ($entry["case_dates"] !== $reviewed[$entry["key"]]) { throw new \RuntimeException("Unexpected reviewed case_dates."); }
    $reviewed = ["prudencia-masancay" => ["Prudencia Masancay", "Prudencia Masaucay"], "apolonio-aranis" => ["Apolonio Aranis", "Apolonio Aranes", "Apolonio Arañez"], "catalino-cabrera" => ["Catalino Cabrera", "Catalinus Cabrera"], "ramon-hernandez" => ["Ramon Hernandez"], "felix-paderona" => ["Felix Paderona", "Felix Paderono"], "leon-badillon" => ["Leon Badillon", "Leon Baullon"], "patricio-alino" => ["Patricio Alino", "Patricio Allino"]];
    if ($entry["match_names"] !== $reviewed[$entry["key"]]) { throw new \RuntimeException("Unexpected reviewed match_names."); }
    $reviewedCases = ["prudencia-masancay" => [["charges" => "US military detention for alleged insurgency; no criminal conviction established", "sentence" => "Released by the commanding officer after an oath, at the request and responsibility of the president of Balayan. The corrected surname above the crossed-out form is used. No individual criminal sentence established for this period."]], "apolonio-aranis" => [["charges" => "US military detention for alleged insurgency; no criminal conviction established", "sentence" => "Released by the commanding officer after taking an oath. The crossed-through or uncertain surgeon wording is not adopted. No individual criminal sentence established for this period."]], "catalino-cabrera" => [["charges" => "US military detention for alleged insurgency; no criminal conviction established", "sentence" => "The individual disposition explicitly records release on oath on December 27, 1900, rather than repeating the preceding December 26 release. No individual criminal sentence established for this period."]], "ramon-hernandez" => [["charges" => "US military detention for alleged insurgency; no criminal conviction established", "sentence" => "Released by the commanding officer on oath under the patronage of the president of Balayan. No individual criminal sentence established for this period."]], "felix-paderona" => [["charges" => "US military detention for alleged insurgency; no criminal conviction established", "sentence" => "Released by the commanding officer on account of sickness. No specific diagnosis established. No individual criminal sentence established for this period."]], "leon-badillon" => [["charges" => "US military detention for alleged insurgency; no criminal conviction established", "sentence" => "Released by the commanding officer after a rifle was brought in. The register does not establish that this person personally brought the rifle. No individual criminal sentence established for this period."]], "patricio-alino" => [["charges" => "US military detention for alleged insurgency; no criminal conviction established", "sentence" => "Released by the commanding officer on March 10, 1901. The capture date is March 4, not the preceding March 3 entry. No individual criminal sentence established for this period."]]];
    if ($entry["prisoner"]["cases"] !== $reviewedCases[$entry["key"]]) { throw new \RuntimeException("Unexpected reviewed cases."); }
    if (isset($entry["photo"])) { throw new \RuntimeException("No portrait was verified for batch339."); }
...
echo "B339-OK\n";
'
run "add-affiliation-prisoners" "B339-OK" "$ADD_CODE" || exit 1
echo "Batch 339 complete (dry run: ${NPPC_BATCH_DRY_RUN})."
