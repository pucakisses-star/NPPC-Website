...
/**
 * Adds three small-format merch items to the store (a bumper sticker, a car
 * magnet, and a fridge magnet), all in the Accessories category. Dedupes by
 * name and is safe to re-run. Products are created without an image so an admin
 * can upload a real photo through the panel.
 */
    ...
    public function handle(): int
    {
        $products = [
            [
                ...
                'price' => 4.00, 'category' => 'Accessories', 'sort_order' => 53,
            ],
            [
                ...
                'price' => 8.00, 'category' => 'Accessories', 'sort_order' => 63,
            ],
            [
                ...
                'price' => 5.00, 'category' => 'Accessories', 'sort_order' => 64,
            ],
        ];
