 ...
 * plus a car magnet and a fridge magnet (Magnets). Dedupes by name and is safe
 * to re-run. Products are created without an image so an admin can upload a real
 * photo through the panel.
 */
