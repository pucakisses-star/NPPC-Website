 ...
 *
 * Recovery follow-up to #483: searches alternate sources for the 41
 * records that #483 nulled out, and recovers 19 more by downloading
 * from Internet Archive mirrors (different IA identifiers than the
 * dead vault.fbi.gov subpaths in the original source list), plus
 * pointing 6 "part-X" slugs to the consolidated PDFs we already have.
 *
 * Total: 147 records self-hosted, 22 still nullable (records survive
 * with title/description; no broken external link).
 *
 * Idempotent.
 */
final class SelfHostExternalImports extends Command {
    protected $signature = 'archive:self-host-external-imports';
    protected $description = 'Self-host external-URL archive records (rev #483-recovery): 147 self-hosted, 22 nulled';
    ...
    public function handle(): int {
        $mapping = [
            ...
            'fbi-cointelpro-swp-part-01' => '/pdfs/external-imports/fbi-cointelpro-swp-consolidated.pdf',
            'fbi-cointelpro-swp-part-05' => '/pdfs/external-imports/fbi-cointelpro-swp-consolidated.pdf',
            'fbi-cointelpro-puerto-rican-groups-part-01' => '/pdfs/external-imports/fbi-cointelpro-puerto-rico-consolidated.pdf',
            'fbi-cointelpro-white-hate-groups-part-01' => '/pdfs/external-imports/fbi-cointelpro-white-hate-groups-part-01.pdf',
            'fbi-martin-luther-king-jr-part-1' => '/pdfs/external-imports/fbi-martin-luther-king-jr-part-1.pdf',
            'fbi-martin-luther-king-jr-part-2' => '/pdfs/external-imports/fbi-martin-luther-king-jr-part-2.pdf',
            'fbi-malcolm-x-part-01' => '/pdfs/external-imports/fbi-malcolm-x-part-01.pdf',
            'fbi-malcolm-x-part-20' => '/pdfs/external-imports/fbi-malcolm-x-part-20.pdf',
            'fbi-malcolm-x-part-33' => '/pdfs/external-imports/fbi-malcolm-x-part-33.pdf',
            'fbi-fred-hampton-part-01' => '/pdfs/external-imports/fbi-fred-hampton-part-01.pdf',
            'fbi-fred-hampton-part-2' => '/pdfs/external-imports/fbi-fred-hampton-part-2.pdf',
            ...
            'fbi-weather-underground-part-1' => '/pdfs/external-imports/fbi-weather-underground-part-1.pdf',
            'fbi-weather-underground-part-6' => '/pdfs/external-imports/fbi-weather-underground-part-6.pdf',
            'fbi-viola-liuzzo-part-1' => '/pdfs/external-imports/fbi-viola-liuzzo-part-1.pdf',
            'fbi-cesar-chavez-part-1' => '/pdfs/external-imports/fbi-cesar-chavez-consolidated.pdf',
            'fbi-cesar-chavez-part-2' => '/pdfs/external-imports/fbi-cesar-chavez-consolidated.pdf',
            'fbi-move-file' => '/pdfs/external-imports/fbi-move-file.pdf',
            'fbi-kathy-boudin-part-01' => '/pdfs/external-imports/fbi-kathy-boudin-part-01.pdf',
            'fbi-jean-seberg-file' => '/pdfs/external-imports/fbi-jean-seberg-file.pdf',
            'fbi-george-jackson-file' => '/pdfs/external-imports/fbi-george-jackson-file.pdf',
            ...
            'goldman-berkman-fragment-prison-1919' => '/pdfs/external-imports/goldman-berkman-fragment-prison-1919.pdf',
            ...
            'churchill-vanderwall-agents-of-repression' => '/pdfs/books/agents-of-repression-churchill-vander-wall-1988.pdf',
        ...
        $unfetchable = [
            ...
            'fag-c1-the-continuing-crime-of-black-imprisonment',
