    ...
    private function people(): array
    {
        return [
            ...
            [
                ...
                'charges' => 'Violating the fugitive-slave laws — for aiding the escape of an enslaved family (the Hawkins family).',
                'convicted' => 'Yes — tried and convicted in federal court at the New Castle Court House (1848).',
                'sentence' => 'Heavy fines that nearly ruined him financially.',
                'incarceration' => [1848],
            ],
            [
