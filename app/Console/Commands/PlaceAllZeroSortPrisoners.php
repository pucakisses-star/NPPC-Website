...
class PlaceAllZeroSortPrisoners extends Command
{
    ...
    private const PLACEMENTS = [
        ...
        // Bedford County four (Oct 1794), rest of the Philadelphia convoy,
        // escapes/parole cases, then the 1795 federal commitments.
        ['herman-husband'                  , 'william-johnson'],
        ['robert-philson'                  , 'herman-husband'],
        ['george-wisegarver'               , 'robert-philson'],
        ['george-lucas'                    , 'george-wisegarver'],
        ['john-black'                      , 'george-lucas'],
        ['david-bolton'                    , 'john-black'],
        ['james-stewart'                   , 'david-bolton'],
        ['john-barnett'                    , 'james-stewart'],
        ['thomas-miller'                   , 'john-barnett'],
        ['samuel-nye'                      , 'thomas-miller'],
        ['philip-vigol'                    , 'samuel-nye'],
        ['joseph-posey'                    , 'philip-vigol'],
        ['marmaduke-curtis'                , 'joseph-posey'],
        ['thomas-burney'                   , 'marmaduke-curtis'],
        ['joseph-scott'                    , 'thomas-burney'],
        ['caleb-mountz'                    , 'joseph-scott'],
        ['isaac-walker'                    , 'caleb-mountz'],
        ['peter-lisle'                     , 'isaac-walker'],
        ['thomas-lapsley'                  , 'peter-lisle'],
        ['benjamin-parkinson'              , 'thomas-lapsley'],
        ['john-holcroft'                   , 'benjamin-parkinson'],
        ['john-mitchell'                   , 'john-holcroft'],
        ['john-cresswell'                  , 'john-mitchell'],
        ['william-bonham'                  , 'john-cresswell'],
