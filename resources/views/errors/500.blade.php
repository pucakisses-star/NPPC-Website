...
<style>
    ...
    .error-code { font-size: 8rem; font-weight: 900; color: rgba(var(--fg-rgb),0.06); line-height: 1; letter-spacing: 0.04em; margin-bottom: -10px; }
    .error-icon { font-size: 64px; line-height: 1; margin-bottom: 16px; opacity: 0.6; }
    .error-title { font-size: 2rem; font-weight: 800; color: var(--fg); margin: 24px 0 16px; }
    .error-desc { font-size: 16px; color: rgba(var(--fg-rgb),0.5); line-height: 1.7; max-width: 540px; margin: 0 auto 40px; }
