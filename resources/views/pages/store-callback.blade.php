...
<style>
    ...
    .oc-title { font-size: 2.2rem; font-weight: 900; color: #fff; margin-bottom: 12px; }
    .oc-title.warn { color: #ffb347; }
    .oc-sub { font-size: 16px; color: rgba(255,255,255,0.65); line-height: 1.7; margin-bottom: 32px; }
    .oc-ref { display: inline-block; background: #16181f; border: 1px solid rgba(255,255,255,0.15); border-radius: 6px; padding: 10px 18px; color: #fff; font-weight: 700; letter-spacing: 0.05em; margin-bottom: 32px; }
    .oc-items { text-align: left; max-width: 480px; margin: 0 auto 32px; }
    .oc-item { display: flex; justify-content: space-between; padding: 12px 0; border-bottom: 1px solid rgba(255,255,255,0.1); color: rgba(255,255,255,0.8); font-size: 15px; }
    .oc-total { display: flex; justify-content: space-between; padding: 14px 0; color: #fff; font-weight: 800; font-size: 17px; }
    .oc-btn { display: inline-block; background: #5660fe; color: #fff; padding: 14px 32px; border-radius: 4px; text-decoration: none; font-weight: 700; }
    .oc-btn:hover { background: #4049d6; }
</style>
@endsection
...
<div class="oc-page">
    ...
    @else
        ...
        <p class="oc-sub">Your order hasn't been confirmed{{ $paymentStatus ? ' (status: '.$paymentStatus.')' : '' }}. If you believe you were charged, email <a href="mailto:info@nationalpoliticalprisonercoalition.org" style="color:#8b93ff;">info@nationalpoliticalprisonercoalition.org</a> and we'll sort it out right away.</p>
