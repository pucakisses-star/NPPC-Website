...
@section('body')
    <div class="podcast-wrap" style="max-width: 900px; margin: 0 auto; padding: 48px 24px 80px;">
        <h1 style="font-size: 3rem; font-weight: 900; color: var(--fg); margin-bottom: 16px;">Podcast</h1>
        <p style="font-size: 18px; color: rgba(var(--fg-rgb),0.6); line-height: 1.7; margin-bottom: 40px; max-width: 600px;">
