...
<style>
    ...
    .ch-intl-ico { width: 55%; height: 55%; display: flex; align-items: center; justify-content: center; color: rgba(var(--fg-rgb),0.32); transition: color 0.15s; }
...
@php
    ...
    $chStateNames = [
        'CA' => 'California', 'IL' => 'Illinois', 'PA' => 'Pennsylvania', 'MA' => 'Massachusetts',
        'NY' => 'New York', 'FL' => 'Florida', 'GA' => 'Georgia', 'DC' => 'District of Columbia',
        'MI' => 'Michigan', 'OR' => 'Oregon', 'RI' => 'Rhode Island',
    ];
    ...
    // Real, currently listed chapters of two allied prisoner-support
    // networks: the Anarchist Black Cross Federation's ten collectives
    // (per abcf.net/contact) and the National Jericho Movement's ten
    // chapters (per thejerichomovement.com/chapters). Mailing addresses
    // are the public PO boxes each collective publishes for letters.
    $abcfUrl = 'https://www.abcf.net/contact/';
    $jerichoUrl = 'https://www.thejerichomovement.com/chapters';
    $chapters = [
        // — Anarchist Black Cross Federation —
        ['st' => 'CA', 'org' => 'Anarchist Black Cross Federation', 'url' => $abcfUrl, 'loc' => 'Bakersfield, CA', 'city' => 'Bakersfield ABCF', 'desc' => 'Political-prisoner support and the ABCF Warchest. Mail: 10812 Tamarron Drive, Bakersfield, CA 93311.'],
        ['st' => 'IL', 'org' => 'Anarchist Black Cross Federation', 'url' => $abcfUrl, 'loc' => 'Chicago, IL', 'city' => 'Chicago ABCF', 'desc' => 'Letter-writing and prisoner support. Mail: 1321 N Milwaukee Ave PMB 460, Chicago, IL 60622.'],
        ['st' => 'CA', 'org' => 'Anarchist Black Cross Federation', 'url' => $abcfUrl, 'loc' => 'Upland, CA', 'city' => 'Inland Empire ABCF', 'desc' => 'Prisoner support in the Inland Empire; Spanish-language contact chapter. Mail: P.O. Box 1124, Upland, CA 91785.'],
        ['st' => 'PA', 'org' => 'Anarchist Black Cross Federation', 'url' => $abcfUrl, 'loc' => 'Lancaster, PA', 'city' => 'Lancaster ABCF', 'desc' => 'Political-prisoner support in central Pennsylvania. Mail: P.O. Box 8682, Lancaster, PA 17604.'],
        ['st' => 'CA', 'org' => 'Anarchist Black Cross Federation', 'url' => $abcfUrl, 'loc' => 'Los Angeles, CA', 'city' => 'Los Angeles ABCF', 'desc' => 'Branch group organizing Running Down the Walls and the Warchest. Mail: P.O. Box 11223, Whittier, CA 90603.'],
        ['st' => 'MA', 'org' => 'Anarchist Black Cross Federation', 'url' => $abcfUrl, 'loc' => 'Lowell, MA', 'city' => 'Lowell/Lawrence ABCF', 'desc' => 'Merrimack Valley prisoner support. Mail: P.O. Box 1163, Lowell, MA 01853.'],
        ['st' => 'NY', 'org' => 'Anarchist Black Cross Federation', 'url' => $abcfUrl, 'loc' => 'Brooklyn, NY', 'city' => 'New York City ABCF', 'desc' => 'Letter-writing and political-prisoner campaigns. Mail: P.O. Box 110034, Brooklyn, NY 11211.'],
        ['st' => 'CA', 'org' => 'Anarchist Black Cross Federation', 'url' => $abcfUrl, 'loc' => 'Santa Ana, CA', 'city' => 'Orange County ABCF', 'desc' => 'Orange County prisoner support. Mail: P.O. Box 4341, Santa Ana, CA 92702.'],
        ['st' => 'PA', 'org' => 'Anarchist Black Cross Federation', 'url' => $abcfUrl, 'loc' => 'Philadelphia, PA', 'city' => 'Philadelphia ABCF', 'desc' => 'Prisoner support and monthly letter-writing; Spanish-language contact chapter.'],
        ['st' => 'FL', 'org' => 'Anarchist Black Cross Federation', 'url' => $abcfUrl, 'loc' => 'Miami, FL', 'city' => 'South Florida ABCF', 'desc' => 'South Florida prisoner support. Mail: c/o Cienfuegos Cooperative, 11850 Biscayne Blvd #305, Miami, FL 33181.'],
        // — National Jericho Movement —
        ['st' => 'GA', 'org' => 'Jericho Movement', 'url' => $jerichoUrl, 'loc' => 'Atlanta, GA', 'city' => 'Atlanta Jericho', 'desc' => 'Southeast-region representative of the National Jericho Movement to free political prisoners and POWs.'],
        ['st' => 'IL', 'org' => 'Jericho Movement', 'url' => $jerichoUrl, 'loc' => 'Chicago, IL', 'city' => 'Chicago Jericho', 'desc' => 'Chicago chapter of the national movement to free political prisoners and prisoners of war.'],
        ['st' => 'DC', 'org' => 'Jericho Movement', 'url' => $jerichoUrl, 'loc' => 'Washington, DC', 'city' => 'D.C. Jericho', 'desc' => 'Organizes around political prisoners and mass incarceration; hosts the annual Assata Shakur Liberation and Education Day.'],
        ['st' => 'MI', 'org' => 'Jericho Movement', 'url' => $jerichoUrl, 'loc' => 'Detroit, MI', 'city' => 'Detroit Jericho', 'desc' => 'Organizes for the freedom of U.S.-held political prisoners and prisoners of war.'],
        ['st' => 'MA', 'org' => 'Jericho Movement', 'url' => 'https://www.thejerichomovement.com/chapters/jericho-boston', 'loc' => 'Boston, MA', 'city' => 'Jericho Boston', 'desc' => 'Boston-area supporters of political prisoners and prisoners of war.'],
        ['st' => 'NY', 'org' => 'Jericho Movement', 'url' => 'https://www.thejerichomovement.com/chapters/new-york-city-jericho', 'loc' => 'New York, NY', 'city' => 'New York City Jericho', 'desc' => 'Coalition chapter across the Bronx, Manhattan, and Brooklyn, with members of ProLibertad and NYC Free Leonard Peltier.'],
        ['st' => 'CA', 'org' => 'Jericho Movement', 'url' => $jerichoUrl, 'loc' => 'Oakland, CA', 'city' => 'Oakland Jericho', 'desc' => 'Bay Area chapter of the National Jericho Movement.'],
        ['st' => 'OR', 'org' => 'Jericho Movement', 'url' => $jerichoUrl, 'loc' => 'Portland, OR', 'city' => 'Oregon Jericho', 'desc' => 'Portland-based grassroots organization fighting for the human rights of the wrongly incarcerated.'],
        ['st' => 'RI', 'org' => 'Jericho Movement', 'url' => $jerichoUrl, 'loc' => 'Providence, RI', 'city' => 'Providence Jericho', 'desc' => 'Providence chapter of the National Jericho Movement.'],
        ['st' => 'NY', 'org' => 'Jericho Movement', 'url' => $jerichoUrl, 'loc' => 'Rochester, NY', 'city' => 'Rochester Jericho', 'desc' => 'Supports the clemency campaigns for Kamau Sadiki and Joy Powell.'],
    ];

    // International political-prisoner support organizations (side panel).
    // Real, active groups in the international Anarchist Black Cross
    ...
    // CAN/MEX/GBR are the original hand-placed outlines; DEU/AUT/BLR were
    // generated from public-domain Natural Earth country boundaries with
    // the same fit.
    $chIntlIcons = [
        ...
        'DEU' => 'M18.3,2.0L18.3,3.8L21.3,4.9L21.3,6.6L24.3,5.7L25.9,4.4L29.2,6.3L30.6,7.7L31.3,10.1L30.5,11.4L31.6,13.1L32.3,15.6L32.1,17.2L33.3,20.2L32.0,20.7L31.2,20.1L30.4,21.0L28.3,21.9L27.2,23.1L25.1,24.1L25.6,25.5L25.9,27.5L27.4,28.6L29.1,30.6L28.1,32.8L27.0,33.4L27.4,36.4L27.1,37.2L26.2,36.3L24.8,36.1L22.7,37.0L20.1,36.8L19.7,38.0L18.2,36.7L17.3,37.0L14.2,35.5L13.6,36.5L11.1,36.5L11.4,33.2L12.9,30.0L8.7,29.1L7.3,27.9L7.5,25.8L6.9,24.8L7.2,21.6L6.7,16.7L8.5,16.7L9.2,14.9L10.0,10.6L9.4,9.0L10.0,8.0L12.5,7.8L13.0,8.8L15.0,6.5L14.3,4.8L14.2,2.1L16.4,2.7L18.3,2.0Z',
        'AUT' => 'M38.0,17.2L37.6,20.1L34.9,20.2L35.9,21.7L34.3,26.3L33.4,27.5L29.2,27.7L26.7,29.3L22.8,28.8L15.9,26.9L14.8,24.4L10.1,25.7L9.5,27.0L6.6,26.0L4.2,25.8L2.0,24.5L2.7,22.8L2.5,21.5L4.0,21.1L6.4,23.1L7.1,21.2L11.3,21.5L14.8,20.2L17.1,20.5L18.6,21.9L19.0,20.7L18.3,16.0L20.1,15.1L21.8,11.9L25.3,14.1L28.0,11.2L29.7,10.7L33.4,12.9L35.7,12.5L37.9,13.9L37.5,14.8L38.0,17.2Z',
        'BLR' => 'M3.1,18.9L6.7,19.0L10.9,16.5L11.7,12.9L14.8,10.9L14.5,8.0L16.8,6.9L20.9,4.5L24.9,6.1L25.4,7.7L27.4,6.9L31.1,8.4L31.5,11.4L30.7,13.2L33.0,17.4L34.6,18.5L34.4,19.7L36.9,20.8L38.0,22.5L36.5,23.9L33.5,23.7L32.7,24.3L33.6,26.4L34.6,30.5L31.3,30.9L30.1,32.3L29.9,35.5L28.4,34.9L25.0,35.2L24.0,33.7L22.5,34.9L21.1,33.9L18.1,33.8L13.9,32.3L10.1,31.8L7.1,31.9L5.1,33.6L3.2,33.9L3.2,31.0L2.0,28.1L4.3,26.8L4.3,24.2L3.2,21.8L3.1,18.9Z',
    ];
    ...
    <div class="ch-mapband-inner">
        <div class="ch-mapwrap">
            <div class="ch-map-col">
                <div class="ch-map-prompt" id="ch-prompt">Select a state to find Anarchist Black Cross and Jericho Movement chapters near you</div>
                @include('partials.us-chapters-map')
            </div>
            <aside class="ch-intl">
                <h3 class="ch-intl-h">Around<br>the World</h3>
        ...
        <div class="ch-all-head">
            <div class="ch-all-title">All Chapters &mdash; Anarchist Black Cross Federation &amp; National Jericho Movement</div>
            <button type="button" class="ch-reset" id="ch-reset">&times; Show all</button>
        </div>
        <div class="ch-all-grid" id="ch-allgrid">
            @foreach($chapters as $c)
                <a class="ch-ccard" href="{{ $c['url'] }}" target="_blank" rel="noopener" data-state="{{ $c['st'] }}">
                    <div class="ch-ccard-top">
                        <span class="ch-ccard-label">{{ $c['org'] }}</span>
        ...
        <div class="ch-empty" id="ch-empty" hidden>
            No Anarchist Black Cross or Jericho Movement chapter in <strong class="ch-empty-state"></strong> yet.
...
<script>
    (function () {
        ...
        function clear() {
            prompt.textContent = 'Select a state to find Anarchist Black Cross and Jericho Movement chapters near you';
        ...
        // International org boxes behave like states (no cursor tooltip).
